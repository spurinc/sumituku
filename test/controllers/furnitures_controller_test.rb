...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post furnitures_url, params: { furniture: { category: @furniture.category, furniture_image: @furniture.furniture_image, name: @furniture.name } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { category: @furniture.category, furniture_image: @furniture.furniture_image, name: @furniture.name } }
